...
const Home = () => {
  ...
  return (
    <div className=" w-screen h-screen flex flex-col items-center justify-center bg-cover bg-top bg-no-repeat">
      <div className="slider justify-center flex flex-col items-center md:flex-col lg:flex-row lg:justify-end md:items-end lg:pt-30 lg:pb-20 md:pt-20">
        {SlidesData.map((data) => {
          return (
